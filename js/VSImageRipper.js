...
VSImageRipper.prototype.XHRGet = function(url,callback){
  var xhr = new XMLHttpRequest();
 ...
 */
VSImageRipper.prototype.parseProduct = function(res) {
 ...
 * 
 * */
VSImageRipper.prototype.getImageURLs = function() {
...
VSImageRipper.prototype.writeImageArray = function() {
 ...
 */
VSImageRipper.prototype.parseMenu = function(res){
...
*/
    menuArray = ['https://www.victoriassecret.com/lingerie/teddies'];
